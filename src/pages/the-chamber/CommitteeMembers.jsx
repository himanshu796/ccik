                ...
                <div className="pt-10 pb-4 px-4 md:px-8 bg-[#F6F0D7] w-full">
                    <div className='max-w-6xl mx-auto'>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                            ...
                            <div className='bg-[#F3E8DF] shadow p-10 md:p-12'>
                                ...
                                {loading ? (
                                    ...
                                    <div className='flex flex-col gap-6'>
                                        {members.map(m => (
                                            <div
                                                key={m.id}
                                                className="bg-[#A3DC9A] p-4 rounded-lg shadow"
                                            >
                            ...
                            <div className='flex flex-col gap-8'>
                                ...
                                <div className='bg-[#A3DC9A] shadow p-10 md:p-12'>
                                    <h2 className="text-2xl md:text-3xl text-center font-bold mb-8">
                                        Co-opted Members
                                    </h2>
                                    ...
                                    <div className='flex flex-col gap-6'>
                                        {cooptedmembers.map(m => (
                                            <div
                                                key={m.id}
                                                className="bg-[#F3E8DF] p-4 rounded-lg shadow"
                                            >
